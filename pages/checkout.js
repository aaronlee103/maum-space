...
export default function CheckoutPage() {
  ...
  const [form, setForm] = useState({
    ...
    deliveryMethod: '\uBB38 \uC55E',
    deliveryOtherText: '',
    entranceType: 'free', entranceCode: '',
    message: ''
  });
  ...
  const openPostcode = () => {
    const doOpen = () => {
      new window.daum.Postcode({ oncomplete: (data) => {
        setForm(f => ({ ...f, recipientPostcode: data.zonecode, recipientAddress: data.roadAddress || data.jibunAddress }));
      }}).open();
    };
  ...
  const deliveryOptions = ['\uBB38 \uC55E', '\uC9C1\uC811 \uBC1B\uACE0 \uBD80\uC7AC \uC2DC \uBB38 \uC55E', '\uACBD\uBE42\uC2E4', '\uD0DD\uBC30\uD568', '\uAE30\uD0C0\uC0AC\uD56D'];
      ...
      <div style={s.page}>
        <nav style={s.nav}>
          ...
          <div style={s.navRight}>
            {user ? (
              <button style={s.navLink} onClick={() => router.push('/mypage')}>{'\uB9C8\uC774\uD398\uC774\uC9C0'}</button>
            ) : (
              <button style={s.navLink} onClick={() => router.push('/login?redirect=/checkout')}>{'\uB85C\uADF8\uC778'}</button>
            )}
        ...
        <div style={s.container}>
          ...
          <p style={s.subtitle}>{user ? '\uC800\uC7A5\uB41C \uC815\uBCF4\uB97C \uBD88\uB7EC\uC654\uC2B5\uB2C8\uB2E4. \uD544\uC694\uD558\uBA74 \uC218\uC815\uD558\uC138\uC694.' : '\uC8FC\uBB38\uC790 \uC815\uBCF4\uC640 \uD55C\uAD6D \uC218\uB839\uC778 \uC815\uBCF4\uB97C \uC785\uB825\uD574\uC8FC\uC138\uC694'}</p>
          <form onSubmit={handleSubmit}>
            ...
            <div style={s.row}>
              ...
              <div style={s.field}><label style={s.label}>{'\uC5F0\uB77D\uCC98'}</label><input style={s.input} name="recipientPhone" value={form.recipientPhone} onChange={handleChange} placeholder="010-0000-0000" required /></div>
            </div>
            ...
            <p style={s.note}>{'\uBB34\uB8CC\uBC30\uC1A1 \uC0C1\uD488\uC758 \uACB0\uC6B0 \uCD94\uAC00 \uBC30\uC1A1\uBE44\uAC00 \uC5C6\uC73C\uBA70, \uC720\uB8CC\uBC30\uC1A1 \uC0C1\uD488\uC758 \uACBD\uC6B0 \uC2E4\uC81C \uBC30\uC1A1\uBE44\uAC00 \uBC1C\uC0DD\uD558\uBA74 \uBCC4\uB3C4\uB85C \uC548\uB0B4\uB4DC\uB9BD\uB2C8\uB2E4.'}</p>
          </form>
        </div>
      </div>
    </>
